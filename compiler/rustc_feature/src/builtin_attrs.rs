...
pub static BUILTIN_ATTRIBUTES: &[BuiltinAttribute] = &[
    ...
    rustc_attr!(rustc_builtin_macro),
    rustc_attr!(rustc_proc_macro_decls),
    rustc_attr!(rustc_macro_transparency, "used internally for testing macro hygiene"),
    rustc_attr!(rustc_autodiff),
    rustc_attr!(rustc_offload_kernel),
    ...
    rustc_attr!(rustc_do_not_const_check, "`#[rustc_do_not_const_check]` skips const-check for this function's body"),
    rustc_attr!(rustc_const_stable_indirect, "this is an internal implementation detail"),
    rustc_attr!(rustc_intrinsic_const_stable_indirect, "this is an internal implementation detail"),
    rustc_attr!(rustc_allow_const_fn_unstable, "rustc_allow_const_fn_unstable side-steps feature gating and stability checks"),
